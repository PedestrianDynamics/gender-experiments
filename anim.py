...
def _get_colormap(frame_data: pd.DataFrame, max_speed: float, color_mode: str) -> List[Scatter]:
...
def _get_shapes_for_frame(frame_data: pd.DataFrame, min_speed: float, max_speed: float, color_mode: str) -> Tuple[Shape, Scatter, Shape]:
...
def animate(
    ...
    *,
    ...
    for frame_num in selected_frames:
        ...
        shapes, hover_traces, arrows = _get_shapes_for_frame(frame_data, min_speed, max_speed, color_mode)
